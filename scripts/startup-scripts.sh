...
$PATHDATA/playout_controls.sh -c=setvolumetobootvolume
$PATHDATA/playout_controls.sh -c=setvolumetostartup

####################
# play startup sound
mpgvolume=$((32768*${AUDIOVOLBOOT}/100))
echo "${mpgvolume} is the mpg123 startup volume"
/usr/bin/mpg123 -f -${mpgvolume} $PATHDATA/../shared/startupsound.mp3
